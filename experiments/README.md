...
Additionally, in `randresnet_configs.sh` and `resnet_configs.sh` you can find the optimal configurations identified during model selection and used in our experiments, for randResNet and fully-trainable ResNet, respectively.
